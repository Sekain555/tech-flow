...
export class MenuresumenPage implements OnInit {
  ...
  ngOnInit() {
    this.perfil = this.session.role;
    this.taller = this.session.tenantId;
  }
        ...
        datasets: [
          {
            ...
            data: [24, 30, 18, 36],
            backgroundColor: ['rgba(1, 46, 228, 1)'],
            borderColor: ['rgba(1, 46, 228, 1)'],
            borderWidth: 1,
          },
        ],
      },
        ...
        datasets: [
          {
            ...
            data: [
              205000, 155000, 220000, 215000, 165000, 0, 240000, 325000, 260000,
              265000, 315000, 275000, 0, 130000, 120000, 130000, 195000, 140000,
              190000, 0, 325000, 265000, 260000, 315000, 275000, 315000, 0,
              155000, 215000, 220000,
            ],
            backgroundColor: [
              'rgba(255, 99, 132, 0.2)',
              'rgba(54, 162, 235, 0.2)',
